...
# load grids
#gdd50 <-stack("./fixed/anomDOY_baseT0_thresh50_1981-2010.grd")
#gdd250<-stack("./fixed/anomDOY_baseT0_thresh250_1981-2010.grd")
gdd450<-stack("./fixed/anomDOY_baseT0_thresh450_1981-2010.grd")

# aggregate to lower resolution grids
# gdd50_x4 <- aggregate(gdd50, fact=4, fun=mean)
# writeRaster(gdd50_x4,filename="./fixed/X4_anomDOY_baseT0_thresh50_1981-2010.grd", overwrite=TRUE)
 gdd450_x4 <- aggregate(gdd450, fact=4, fun=mean)
 writeRaster(gdd450_x4,filename="./fixed/X4_anomDOY_baseT0_thresh450_1981-2010.grd", overwrite=TRUE)
#gdd250_x4 <- aggregate(gdd250, fact=4, fun=mean)
#writeRaster(gdd250_x4,filename="./fixed/X4_anomDOY_baseT0_thresh250_1981-2010.grd", overwrite=TRUE)

#raw grids
# gdd50raw<-stack("./fixed/rawDOY_baseT0_thresh50.grd")
#   gdd50raw_x4 <- aggregate(gdd50raw, fact=4, fun=mean)
#   writeRaster(gdd50raw_x4,filename="./fixed/X4_rawDOY_baseT0_thresh50.grd", overwrite=TRUE)
# gdd250raw<-stack("./fixed/rawDOY_baseT0_thresh250.grd")
#  gdd250raw_x4 <- aggregate(gdd250raw, fact=4, fun=mean)
#  writeRaster(gdd250raw_x4,filename="./fixed/X4_rawDOY_baseT0_thresh250.grd", overwrite=TRUE)
gdd450raw<-stack("./fixed/rawDOY_baseT0_thresh450.grd")
  gdd450raw_x4 <- aggregate(gdd450raw, fact=4, fun=mean)
  writeRaster(gdd450raw_x4,filename="./fixed/X4_rawDOY_baseT0_thresh450.grd", overwrite=TRUE)

# mean DOY grids  
  # meanDOY50<-raster("./fixed/meanDOY_baseT0_thresh50_1981-2010.grd")
  # meanDOY50_x4 <- aggregate(meanDOY50, fact=4, fun=mean)
  # writeRaster(meanDOY50_x4,filename="./fixed/X4_meanDOY_baseT0_thresh50_1981-2010.grd", overwrite=TRUE)
  
 # meanDOY250<-raster("./fixed/meanDOY_baseT0_thresh250_1981-2010.grd")
 # meanDOY250_x4 <- aggregate(meanDOY250, fact=4, fun=mean)
 # writeRaster(meanDOY250_x4,filename="./fixed/X4_meanDOY_baseT0_thresh250_1981-2010.grd", overwrite=TRUE)
  
  meanDOY450<-raster("./fixed/meanDOY_baseT0_thresh450_1981-2010.grd")
  meanDOY450_x4 <- aggregate(meanDOY450, fact=4, fun=mean)
  writeRaster(meanDOY450_x4,filename="./fixed/X4_meanDOY_baseT0_thresh450_1981-2010.grd", overwrite=TRUE)
...
# create mask
  ...
  # 
  # writeRaster(sum0GDDall,filename="./fixed/maskNA_baseT0.grd", overwrite=TRUE)
  # 
...
sum0GDDall[sum0GDDall > 0] <- NA
# plot(sum0GDDall) # check  
writeRaster(sum0GDDall,filename="./fixed/maskNAalt_baseT0.grd", overwrite=TRUE)
